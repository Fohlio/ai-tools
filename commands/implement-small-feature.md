...
You are orchestrating a lightweight feature implementation. This workflow is for small, well-scoped features that don't require the full 7-phase pipeline. It covers **Planning, Implementation, and Refactoring**.

---

## MANDATORY EXECUTION PROTOCOL

> **All phases below are MANDATORY. Skipping or self-performing phases is a WORKFLOW VIOLATION.**
...
2. **No placeholders** — Every requested feature must be fully implemented. Never leave `TODO`, `FIXME`, or stub comments.
