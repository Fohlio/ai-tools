...
Building software agents requires different prompting strategies than single-turn interactions. (Note: For advanced agent architecture, multi-agent orchestration, and production-ready agent systems, use the `agentic-systems` skill).
...
- See the `agentic-systems` skill for comprehensive research on production-ready agentic systems, multi-agent orchestration, and agent architecture.
